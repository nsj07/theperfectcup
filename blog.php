        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <button type="button" class="btn btn-info btn-default btn-lg" data-toggle="modal" data-target="#myModal1">Read More</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    ...
                    <h2>COCONUT OIL COFFEE
                        <br>
                        <small>June 1, 2021</small>
                    </h2>
                    <p>Start your morning off with this great recipe for hot coffee with coconut oil and butter.</p>
                    <button type="button" class="btn btn-info btn-default btn-lg" data-toggle="modal" data-target="#myModal2">Read More</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    ...
                    <h2>IRISH COFFEE 
                        <br>
                        <small>June 3, 2021</small>
                    </h2>
                    <p>Take the edge off with a Fresh hot cup of coffee made with Irish whiskey and Irish Cream.</p>
                    <button type="button" class="btn btn-info btn-default btn-lg" data-toggle="modal" data-target="#myModal3">Read More</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    <ul class="pager">
